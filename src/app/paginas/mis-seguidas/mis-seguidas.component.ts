...
@Component({
  selector: 'app-mis-seguidas',
  templateUrl: './mis-seguidas.component.html',
  styleUrls: ['./mis-seguidas.component.scss']
})
export class MisSeguidasComponent {
  datos: any = {
    etiquetas: [],
    generos: [],
    pagina: 1,
  ...
  ngOnInit() {
    ...
    this.subscripcion = this.servicioNovela.misSeguidas().subscribe((data) => {
